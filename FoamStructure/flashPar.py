...
# Resolve the directory containing this file so simConfig can be found
# regardless of the working directory FLASH uses at runtime.
try:
    _THIS_DIR = os.path.dirname(os.path.abspath(__file__))
except NameError:
    # __file__ may not exist if FLASH exec()s this file directly
    _THIS_DIR = os.getcwd()
