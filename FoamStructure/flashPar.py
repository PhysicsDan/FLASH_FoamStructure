...
# ==================================================================
#  FLASH setup and runtime parameters below.
#  The sentinel blocks inside the functions are auto-generated by
#  generateConfig.py — do not edit them manually.
# ==================================================================


def setupArgs():
    # <<< GENERATED_SETUP_BEGIN >>>
    _SPECIES_STR = "species=cham,tar1,tar2"
    # <<< GENERATED_SETUP_END >>>
    args = [
        "-auto",
        "-2d",
...
def parms():
    ...
    CUSTOM_DENS_MAP_FILE = "density_map.npz"
    USE_BDRY = True
    BDRY_TEMP_THRESHOLD = 1000.0
    BDRY_UNFREEZE_DIST = 0.0005
    # <<< GENERATED_PARMS_END >>>
    ...
    p.sim_vacuumHeight(CHAMBER["height"])
    p.sim_initGeom("slab")
